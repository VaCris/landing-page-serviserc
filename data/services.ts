...
export const services: Service[] = [
  ...
  {
    slug: 'actualizacion-de-sire',
    title: 'Actualización de SIRE',
    categories: ['contable'],
    excerpt: 'Mantenemos tu información actualizada en el Sistema de Información Tributaria (SIRE).',
    description: 'Nos encargamos de la actualización y mantenimiento de tu información en el SIRE para cumplir con las obligaciones tributarias.',
    image: '/img/actualizacion-de-sire.webp',
